...
public class DicomViewerACTOutline : MonoBehaviour
{
    ...
    {
        var modelPath = Path.Combine(Application.streamingAssetsPath, "Models", "ACT.glb"); //ACTreal_prova
        ...
        //attachedModel.GetComponent<MeshFilter>().transform.position = new Vector3(-0.03f, 0.0017f, 0.28f);
        //attachedModel.GetComponent<MeshFilter>().mesh.RecalculateBounds();
        attachedModel.transform.localPosition = new Vector3(-0.03f, 0.0017f, 0.28f);
    }
