...
namespace Microsoft.MixedReality.Toolkit.Experimental.UI
{
    ...
    /// </summary>
    [AddComponentMenu("MRTK/SDK/Experimental/CustomStepSlider")]
    public class CustomStepSlider : PinchSlider, IMixedRealityPointerHandler
    {
        ...
        public int SliderStepDivisions
        {
            ...
            set
            {
                ...
                // Update the slider state to be consistent with the new values
                UpdateStepVal();
                CheckSliderInit();
            }
        }
        ...
        /// <summary>
        /// Reference to a sound event handler that allows the tick sounds to be customized.
        /// </summary>
        private CustomSliderSounds soundHandler;
        ...
        private void UpdateStepVal()
        {
            ...
            {
                soundHandler = GetComponent<CustomSliderSounds>();
                soundHandler.MinSecondsBetweenTicks = 0;
                soundHandler.TickEvery = 0;
            }
