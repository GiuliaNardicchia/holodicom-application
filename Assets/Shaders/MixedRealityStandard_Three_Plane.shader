...
Shader "Mixed Reality Toolkit/Standard_Three_Plane"
{
    Properties
    {
        // Main maps.
    ...
    SubShader
    {
...
#if defined(_CLIPPING_PLANE) || defined(_CLIPPING_PLANE2) || defined(_CLIPPING_PLANE3) || defined(_CLIPPING_SPHERE) || defined(_CLIPPING_BOX)
        ...
        #undef _CLIPPING_PRIMITIVE
            ...
            UNITY_DEFINE_INSTANCED_PROP(fixed, _ClipPlaneSide3)
            UNITY_DEFINE_INSTANCED_PROP(float4, _ClipPlane3)
#endif
...
#endif
#if defined(_CLIPPING_PLANE3)
                fixed clipPlaneSide3 = UNITY_ACCESS_INSTANCED_PROP(Props, _ClipPlaneSide3);
                float4 clipPlane3 = UNITY_ACCESS_INSTANCED_PROP(Props, _ClipPlane3);
                primitiveDistance = min(primitiveDistance, PointVsPlane(i.worldPosition.xyz, clipPlane3) * clipPlaneSide3);
#endif
#if defined(_CLIPPING_SPHERE)
